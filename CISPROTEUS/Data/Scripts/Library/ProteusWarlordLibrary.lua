...
return {
		...
		["CIS_PROTEUS"] = {
			...
			SpaceUnitLimit = 2,
			UnlockList = {"CSA_B1_Droid_Company", "B2_Droid_Company", "Crab_Droid_Company", "Destroyer_Droid_II_Company", "Imperial_Dwarf_Spider_Droid_Company", "STAP_Company",
			...
			LockList = {"Imperial_Proteus_Capital", "Imperial_Proteus_Office", "I_Ground_Barracks", "I_Ground_Light_Vehicle_Factory", "I_Ground_Heavy_Vehicle_Factory", "I_Ground_Advanced_Vehicle_Factory", "Imperial_Army_Guard_Company", "Carida_Academy", "Adz_Patrol_Destroyer"},
			FactionOverride = "Empire",
