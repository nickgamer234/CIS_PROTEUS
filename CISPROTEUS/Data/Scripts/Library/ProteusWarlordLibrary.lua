...
return {
		...
		["CIS_PROTEUS"] = {
			...
			SwapStructures = {"Imperial_Proteus_Capital","Imperial_Proteus_Office", "I_Ground_Barracks", "I_Ground_Light_Vehicle_Factory", "I_Ground_Heavy_Vehicle_Factory", "I_Ground_Advanced_Vehicle_Factory"},
			SwapInfantry = {"Imperial_Army_Trooper_Company","Imperial_Army_Guard_Company","Imperial_Stormtrooper_Company","Shadow_Stormtrooper_Company","Imperial_Jumptrooper_Company","Imperial_Scout_Trooper_Company","Imperial_74Z_Bike_Company"},
			SpaceUnitLimit = 2,
			UnlockList = {"CSA_B1_Droid_Company", "B2_Droid_Company", "AAT_Company", "Munificent", "Recusant_Light_Destroyer", "Providence_Carrier_Destroyer", "Destroyer_Droid_II_Company", "Imperial_Dwarf_Spider_Droid_Company", "Bulwark_I", "Bulwark_II", "Captor", "Lucrehulk_Battleship", "Auxilia", "STAP_Company", "Magna_Octuptarra_Company", "HMP_Company", "OG9_Company", "Hailfire_Company", "HAGM_Company", "Crab_Droid_Company", "HAML_Company", "MTT_Company", "DH_Omni", "PAC_Company", "Pursuer_Enforcement_Ship_Group", "Diamond_Frigate", "Hardcell", "Munifex", "C9979_Carrier", "Lucrehulk_Carrier", "Providence_Dreadnought", "Subjugator"},
			LockList = {"Gamma_ATR_6_Group", "IPV1", "Lancer_Frigate", "Carrack_Cruiser", "Ton_Falk_Escort_Carrier", "Star_Galleon", "Strike_Cruiser",
			"Vindicator_Cruiser", "Acclamator II", "Victory_I_Star_Destroyer", "Victory_II_Star_Destroyer","Procursator_Star_Destroyer",
			"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer",
			"Executor_Star_Dreadnought",
			"Imperial_Army_Trooper_Company", "Imperial_Army_Guard_Company", "Imperial_Army_74Z_Bike_Company", 
			"Imperial_AT_PT_Company", "AT_ST_Company",
			...
			"Imperial_Proteus_Capital", "Imperial_Proteus_Office", "I_Ground_Barracks", "I_Ground_Light_Vehicle_Factory", "I_Ground_Heavy_Vehicle_Factory", "I_Ground_Advanced_Vehicle_Factory", "Imperial_Army_Guard_Company", "Carida_Academy", "Adz_Patrol_Destroyer"},
			FactionOverride = "Empire",
			IntroText = "TEXT_CONQUEST_BFC_DL_INTRO_GENERIC",
			IntroHolo = "IG-88_Loop",
			CustomMissionDialog = true,
			CustomRewardTable = true,
			CustomBuildsTable = true,
			CustomBunkerGarrison = true,
			PlanetParticle = "CIS_Allies"
		},

		-- ["CORELLIAN_PROTEUS"] = {
		-- 	FriendlyName = "Corellian Empire",
		-- 	Planets = {"CORELLIA"},
		-- 	LeaderTable = {"NO_LEGITIMACY", "PITTA_TORPEDO_SPHERE"},
		-- 	LeaderEndingNames = {"Danetta Pitta"},
		-- 	HeroList = {"Pitta_Torpedo_Sphere"},
		-- 	UnlockList = {"Surveyor_Frigate", "Active_Frigate", "Thrustship_Corvette", "Thrustship_Corvette_Torpedo", "Thrustship_Tender", "T_Type_Thrustship", "Victory_I_Frigate", "C_type_Thrustship", "Imperial_DHC", "Gladiator_II"},
		-- 	LockList = {"Lancer_Frigate", "Carrack_Cruiser", "Strike_Cruiser", "Vindicator_Cruiser", "Interdictor_Star_Destroyer", "Imperial_Army_Trooper_Company", "Imperial_Army_Guard_Company", "Imperial_Army_74Z_Bike_Company"},
		-- 	FactionOverride = "Corellia",
		-- 	IntroText = "TEXT_CONQUEST_PROTEUS_CORELLIAN",
		-- 	IntroHolo = "Imperial_Naval_Officer_Loop",
		-- 	PlanetParticle = "Corellia_Allies"
		-- },
}
