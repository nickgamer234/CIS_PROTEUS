...
return {
		...
		["CIS_PROTEUS"] = {
			...
			"Interdictor_Star_Destroyer", "Imperial_I_Star_Destroyer", "Allegiance_Battlecruiser", "Imperial_DHC", 
			"Executor_Star_Dreadnought", "Acclamator_II", "Immobilizer_418",
